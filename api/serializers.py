...
def _mattress_option_matches_product_scope(item, product) -> bool:
    ...
    matches_product = not product_ids or product.id in product_ids or inherits_kids_beds_assignment
...
class ProductSizeSerializer(serializers.ModelSerializer):
    class Meta:
        model = ProductSize
        fields = ("id", "name", "description", "price_delta", "stock_status")
            ...
            if isinstance(raw_variants, list):
                for variant in raw_variants:
                    ...
                    cleaned_variant = {
                        ...
                        "mpn": str(variant.get("mpn") or "").strip(),
                        "gtin": str(variant.get("gtin") or "").strip(),
